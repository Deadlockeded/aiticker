...
export default function HotBadge({ cardId }: { cardId: string }) {
  ...
  return (
    <>
      ...
      <span title="Hot today: +3 in Arena fights" className="absolute bottom-2 right-2 z-10 flex items-center gap-1 rounded-md border border-orange-400/40 bg-black/70 px-1.5 py-0.5 font-mono text-[9px] font-bold text-orange-300 backdrop-blur-sm">
        +{HOT_BOOST} 🔥
      </span>
    </>
  );
