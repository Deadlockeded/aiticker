...
export default function CardReveal({
  ...
  return (
    <>
      ...
      {!isOwned && (
        <>
          <p className="mt-3 text-center font-mono text-[10px] uppercase tracking-[0.2em] text-[#9CB09E]">
      ...
      {isOwned && owned !== null && (
        <div className="mt-3 flex gap-2">
          <Link
            ...
            className="flex-1 border-2 border-[#17301F] px-3 py-2 text-center font-mono text-[11px] font-semibold uppercase tracking-widest text-[#17301F] hover:bg-[#17301F]/5"
          >
            In your binder →
          </Link>
        </div>
