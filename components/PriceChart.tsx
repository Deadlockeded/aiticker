...
export default function PriceChart({ history }: { history: PricePoint[] }) {
  ...
  const color = up ? "var(--up)" : "var(--pink)";
  ...
  return (
    <div className="relative">
      {point && (
        <div
          className="pointer-events-none absolute -top-2 z-10 -translate-x-1/2 whitespace-nowrap rounded-lg border border-line bg-surface px-2.5 py-1.5 text-center font-mono text-xs"
          style={{
